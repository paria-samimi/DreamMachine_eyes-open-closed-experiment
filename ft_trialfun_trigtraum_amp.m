...
dir_tmp='/Users/pariasamimi/Documents/PhD/Sainty check/2022-04-13 Eyes open_closed Board 1/result standard EEG and traumschreiber';
cd(dir_tmp);
A=dir;
streams = load_xdf('eoec-2.xdf');     %%%%%%%%%%%%%%%%%%%%% change%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


%% now let's add to the event struct
event = [];
C = cell(1,9)'; % here adjust length so it will get it manually      %%%%%%%%%%%%%%%%%%%%% change%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
C(:) = {'Markers'};
